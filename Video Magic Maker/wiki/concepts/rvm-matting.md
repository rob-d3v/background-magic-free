---
title: RVM — RobustVideoMatting (matting de alta qualidade)
type: concept
created: 2026-06-14
updated: 2026-06-14
sources: ["agentes/matting_rvm.py"]
tags: [concept, realtime, matting, rvm, robustvideomatting, torch, live]
status: stable
migrated-from: wiki/concepts/rvm-matting.md
...
> ([[entities/live-mode]]) **e** no **render offline HD** do modo Studio
> ([[entities/render-video]]). No live a coerência temporal é um bônus; no
...
No render offline (`agentes/render_video.py`, [[entities/render-video]]) o RVM usa
...
**mesma assinatura** de `LiveMatter.compor` ([[entities/live-mode]]): aceita e
...
## Relacionados
[[concepts/realtime-matting]] · [[entities/live-mode]] · [[entities/render-video]] ·
[[entities/camera-app]] · [[entities/composicao]] ·
