...
## Contexto
O [[components/relighting]] usa **IC-Light fc** (foreground-conditioned, UNet de 8
...
- Usa o `background/bg.png` que [[components/geracao_fundo]] já gera (ou o fundo
...
- [[components/relighting]] permanece `status: in-migration` até o fbc entrar.

## Status
**Em migração.** Registrado em [[log]] (2026-06-13, migration).

## Relacionados
[[components/relighting]] · [[concepts/ic-light]] · [[components/geracao_fundo]] ·
[[decisions/local-vs-colab]] · [[index]]
